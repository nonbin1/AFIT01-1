      ...
      $.ajax({
          ...
          success: function(data) {
              ...
              $.each(data, function(i, item) {
                  ...
                  $("#recommend_app").append('<a href='+item.iphonelink+'><div class="service_box"><div class="services_icon"><img src="'+item.thumbnail+'" alt="" title="" /></div><div class="service_content"><h4>'+item.name+'</h4>'+item.description+'</div><div class="service_right"><i class="fa fa-angle-right fa-3x"></i></div></div></a>');
